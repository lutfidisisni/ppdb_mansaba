            ...
            <tr>
                <td style="width:50%; vertical-align:top;">
                    <table style="width:100%;">
                        ...
                        <tr><th>Nama Peserta Didik</th><td>: <b><?php echo strtoupper($pendaftar['nama_siswa'] ?? '-'); ?></b></td></tr>
...
?></td></tr>
        ...
        <div class="ttd-area row mt-4" style="display: flex; justify-content: space-between; align-items: flex-end;">
            ...
            <div class="col-4 text-center" style="width:33%; text-align:right;">
                ...
                <strong><?php echo strtoupper($pendaftar['nama_siswa'] ?? '-'); ?></strong>
            </div>
        </div>
        ...
        <div class="bukti-daftar">
            ...
            <table class="table-bukti">
                ...
                <tr><th>Nama</th><td>: <?php echo strtoupper($pendaftar['nama_siswa'] ?? '-'); ?></td><th class="text-end">Peminatan</th><td class="text-end">: <?php echo $pendaftar['pilihan_program'] ?? '-'; ?></td></tr>
