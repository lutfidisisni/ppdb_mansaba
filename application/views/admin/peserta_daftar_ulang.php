...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col p-4">
                <h2 class="mb-4">Peserta Daftar Ulang</h2>
                    ...
                    <table class="table table-striped" id="tablePeserta">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo date('d/m/Y', strtotime($p->tanggal_daftar_ulang)); ?></td>
                                <td>
                                    <a href="<?php echo site_url('admin/cetak_bukti_daftar_ulang/' . $p->id); ?>" class="btn btn-sm btn-primary" target="_blank">
