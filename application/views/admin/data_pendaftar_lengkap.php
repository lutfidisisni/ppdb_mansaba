                        ...
                        <table class="table table-striped table-hover align-middle nowrap" id="tablePendaftarLengkap" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo strtoupper($p->nama_siswa ?? '-'); ?></td>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#tablePendaftarLengkap').DataTable({
                ...
                order: [[1, 'asc']],
                columnDefs: [
                    { targets: [35], orderable: false, searchable: false } // Kolom Aksi
                ],
                language: {
            ...
            $.fn.dataTable.ext.search.push(function(settings, data, dataIndex) {
                ...
                var rowJenisKelamin = data[4];
                var rowStatusDaftarUlang = data[34];  // Kolom Status Daftar Ulang
                var rowNomorDaftarUlang = data[35];  // Kolom Nomor Daftar Ulang
                var sekolah = data[11].toLowerCase();  // Kolom Nama Sekolah
                var tanggal = data[33];  // Kolom Tanggal Pendaftaran
