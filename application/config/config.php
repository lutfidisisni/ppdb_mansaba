...
if ($hostname === 'localhost' || $hostname === '127.0.0.1' || strpos($hostname, 'localhost') !== false) {
    ...
    $config['base_url'] = 'https://ppdb.manubanyuputih.id/';
}
...
|
*/
$config['encryption_key'] = 'wyI0fRw0tnEa2xa5aP5TVySWx8h2JY8t';
...
$config['sess_save_path'] = '/www/wwwroot/ppdb.manubanyuputih.id/sessions';
